...
- このファームウェアでは、レイヤー6と7に切り替わった際に、独自のLEDの点灯がされるようにしてあります。

- LEDが手動でONにしてある場合に限りますが、特定キーに「DF(6)」などを割り当てることで、そのキーを離した後も切り替えが持続するので、レイヤーの判別を行うために追加した機能です。

- 4行目の6つのキーのバックライト全てが、以下のように点灯します。
  - レイヤー6のとき青色
  - レイヤー7のとき赤色
