...
|LED SK6812MINI-E(なくてもキーボードは動作します)|36|
|M2ネジ　3mm|7|
|M2ネジ　5mm|7|
|M2スペーサー　12mm|7|
|CherryMX互換キースイッチ|36|
...
以下の図の箇所に、抵抗器とMOSFETをはんだ付けします。ただし非推奨ですが、この回路を組まなくても3.3Vのままの電源を入力すれば、LEDが点灯するようです(非公式に確認済み)。
